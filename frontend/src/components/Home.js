        ...
        <div class="product-container">
          <div class="product-card">
            ...
            <div class="product-info">
              ...
              <h2 class="product-brand">
                <Link to={"/details"}>Nakiyingi Hostel, Kikoni</Link>
              </h2>
          ...
          <div class="product-card">
            ...
            <div class="product-info">
              <br />
              <h2 class="product-brand">
                <Link to={"/details"}>Braeted Girls Hostel, Wandegeya</Link>
              </h2>
          ...
          <div class="product-card">
            ...
            <div class="product-info">
              <br />
              <h2 class="product-brand">
                <Link to={"/hostels"}>Olympia Hostel, Kikoni</Link>
              </h2>
          ...
          <div class="product-card">
            ...
            <div class="product-info">
              <br />
              <h2 class="product-brand">
                <Link to={"/hostels"}>Cheds Hostel, Kikumi Kikumi</Link>
              </h2>
