...
function Hostels() {
  return (
    <div>
        ...
        <div className = "product">
                <h2 class = "product-category">Kikoni A Hostels</h2>
  ...
  4.5
            ...
            <div className = "product">
                <h2 class = "product-category">Kikoni B Hostels</h2>
                <div class = "product-container">
                    <div class = "product-card">
                        <div class = "product-image">  
                        <img src = 
  ...
  4.5
            ...
            <div className = "product">
                <h2 class = "product-category">Wandegeya Hostels</h2>
                <div class = "product-container">
                    <div class = "product-card">
                        <div class = "product-image">  
                        <img src = 
  ...
  4.5
            ...
            <div className = "product">
                <h2 class = "product-category">Kikumi Kikumi Hostels</h2>
                <div class = "product-container">
                    <div class = "product-card">
                        <div class = "product-image">  
                        <img src = 
