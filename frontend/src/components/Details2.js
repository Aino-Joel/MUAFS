...
function Details() {
  ...
  useEffect(() => {
    const fetchHostel = async () => {
      const response = await fetch('https://muafs-backend.onrender.com/api/hostels/'+_id)
  ...
  return (
    <div>
      ...
      <div className="description">
        ...
        <br />
        <h4 className="heading">Rooms available: {hostel.rooms}</h4>
        <table className='"table table-striped"'>
          ...
          <tbody>
            <tr>
              <td scope="row">Single Self-Contained</td>
              <td>1,400,000</td>
            </tr>
            <tr>
              <td scope="row">Single Not Self-Contained</td>
              <td>1,200,000</td>
            </tr>

            <tr>
              <td scope="row">Shared Self-Contained</td>
              <td>950,000</td>
            </tr>
             <tr>
              <td scope="row">Shared Not Self-Contained</td>
              <td>800,000</td>
            </tr>
          </tbody>
        </table>
        ...
        // </Link>
        <h3 className="description-container">Custodian Contact</h3>
        <p className="description-container">
          {hostel.custodian}: {hostel.custodianNo}
        </p>
      </div>
    </div>
  );
