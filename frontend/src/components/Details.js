...
<Link to={'/maps'}>
      ...
      <div className="row">
        <div className="col-md-6 mb-4">
          <ul className="list-unstyled list-group-custom">
            ...
            <li className='list-custom'>
            <div>
    <p className="float-left"><img src="
    https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_N-BKjssvc-9eh4vY0gwPm0wUw50MmqJwgZHBPT-Sgw&s" height="60px" width="60px" style={{ border: '1px solid black' }} className="rounded-circle" />
    &nbsp;  &nbsp;    &nbsp;  &nbsp;
 ...
 <p>I had a great stay at the student hostel. The staff was very friendly, and the facilities were clean and comfortable. The location was also very convenient for exploring the area.</p>

            </li>
            <li className='list-custom'>
            <p className="float-left"><img src=
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_N-BKjssvc-9eh4vY0gwPm0wUw50MmqJwgZHBPT-Sgw&s" height="60px" width="60px" style={{ border: '1px solid black' }} className="rounded-circle" alt="Ron" />
    &nbsp;  &nbsp;    &nbsp;  &nbsp;
 ...
 <p>The security at the student hostel was top-notch with good-sized lockers. The staff was also very pleasant and accommodating, making for a great stay in Montevideo.</p>
              </li>
              <li className='list-custom'>
              <p className="float-left"><img src=
              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_N-BKjssvc-9eh4vY0gwPm0wUw50MmqJwgZHBPT-Sgw&s' height="60px" width="60px" style={{ border: '1px solid black' }} className="rounded-circle" alt="Ron" />
 ...
 <p>The kitchen at the student hostel was well-equipped and clean, and the free coffee was a nice touch. The other guests were friendly and respectful, making for a pleasant stay</p>
              ...
              <li className='list-custom'>
              <p className="float-left"><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_N-BKjssvc-9eh4vY0gwPm0wUw50MmqJwgZHBPT-Sgw&s' height="60px" width="60px" style={{ border: '1px solid black' }} className="rounded-circle" alt="Ron" />
    &nbsp;  &nbsp;    &nbsp;  &nbsp;
